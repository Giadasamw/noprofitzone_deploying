...
export const metadata: Metadata = {
  ...
  description:
    "Studio di consulenza per bandi e rendicontazione. Lavoriamo con fondazioni, ONG ed enti culturali sull'intero ciclo di un progetto finanziato, dalla candidatura alla relazione finale.",
  icons: {
    icon: "/favicon.png",
  },
  verification: {
