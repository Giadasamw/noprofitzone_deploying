    ...
    <section className="contatti-hero">
      <div className="contatti-hero-container">
        <h1 className="contatti-hero-title">
          Trenta minuti, per capire se{" "}
          <em style={{ fontStyle: "italic", fontWeight: 400 }}>lavorare insieme ha senso.</em>
        </h1>
        <p className="contatti-hero-subtitle">
          ...
          Lo studio dice se è in grado di offrire un contributo utile, e in che termini.
        </p>
      </div>
